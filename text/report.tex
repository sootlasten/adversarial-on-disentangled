...
\int q_{\boldsymbol{\phi}}(\boldsymbol{z}|\boldsymbol{x}) \log \frac{p_{\boldsymbol{\theta}}(\boldsymbol{x}, \boldsymbol{z})}{q_{\boldsymbol{\phi}}(\boldsymbol{z}|\boldsymbol{x})} d \boldsymbol{z} \coloneqq \mathcal{L}(\boldsymbol{x}; \boldsymbol{\theta}, \boldsymbol{\phi}). \\
\end{gather*}
...
\begin{gather*}
\int q(\boldsymbol{z}|\boldsymbol{x}) \log \frac{p(\boldsymbol{x} | \boldsymbol{z}) p(\boldsymbol{z})}{q(\boldsymbol{z}|\boldsymbol{x})} d \boldsymbol{z} \stackrel{\text{distributing the logarithm}}{=}\\ 
\int q(\boldsymbol{z}|\boldsymbol{x}) \log p(\boldsymbol{x} | \boldsymbol{z}) d \boldsymbol{z} + \int q(\boldsymbol{z}|\boldsymbol{x}) \log \frac{p(\boldsymbol{z})}{q(\boldsymbol{z}|\boldsymbol{x})} d \boldsymbol{z}  \stackrel{\text{def of KL}}{=}\\
\int q(\boldsymbol{z}|\boldsymbol{x}) \log p(\boldsymbol{x} | \boldsymbol{z}) d \boldsymbol{z} - KL(q(\boldsymbol{z}|\boldsymbol{x}) || p(\boldsymbol{z})).
\end{gather*}
